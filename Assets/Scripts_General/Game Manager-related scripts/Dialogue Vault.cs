    ...
    void Awake()
    {
        ...
        dialogueSets = new DialogueSet[][]
        {
            ...
            new DialogueSet[]
            {
                ...
                new DialogueSet { dialogueLine = "When did this happen?", characterName = "Abdurahman" },
                new DialogueSet { dialogueLine = "Just now! About an hour ago! I was in the living room with them, and then I went to the bathroom, and when I came back, they were all gone!", characterName = "Frantic Teenager" },
                new DialogueSet { dialogueLine = "Did they have VR headsets?", characterName = "Abdurahman" },
                new DialogueSet { dialogueLine = "Yeah! Yeah, they did! How did you know that?", characterName = "Frantic Teenager" },
                new DialogueSet { dialogueLine = "Because the same thing happened to my family.", characterName = "Abdurahman" },
                new DialogueSet { dialogueLine = "Really? So you know what happened to them?", characterName = "Frantic Teenager" },
                new DialogueSet { dialogueLine = "I have a theory. Listen, do you want to help me get them back?", characterName = "Abdurahman" },
                new DialogueSet { dialogueLine = "Yes! Anything! Please!", characterName = "Frantic Teenager" },
                new DialogueSet { dialogueLine = "Good. Meet me at this address tomorrow morning.", characterName = "Abdurahman" },
            }
        };
    }
}
